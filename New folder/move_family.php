...
<script type="text/javascript">
	...
	$(function() {
		...
		.droppable({drop: function (event,div) {
			...
			alert(alerts)
		xmlhttp.open("GET","save_family.php?code="+id+"&name="+name+"&tonode="+tonode+"&fromnode="+fromnode+"&fromnodename="+fromnodename+"&tonodename="+tonodename,true);
		xmlhttp.send();
...
<title>move item in Family</title>
...
echo "<option value='1' selected='selected'>--  Family --</option>";
...
echo "เลือก Family ต้นทาง : <select class='form-control' id='sbegin' onchange='return begin_id(this);'>";
echo "<option value='' data-value='".$b_result[$b]['thaiName']."'>-- เลือก Family ต้นทาง --</option>";
...
echo "เลือก Family ปลายทาง : <select class='form-control' id='sto' onchange='return to_id(this);'>";
echo "<option value='' data-value='".$result[$c]['thaiName']."'>-- เลือก Family ปลายทาง --</option>";
for($c=0;$c<$cnt;$c++){
echo "<option value='".$result[$c]['code']."' data-value='".$result[$c]['thaiName']."'>".$result[$c]['thaiName']." ".$result[$c]['code']."</option>";}
