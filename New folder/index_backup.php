...
<form action='insert_from.php' method='GET'>
	<div class="ltext">
	<input type='text' name='id' id='add' class="form-control">
	</div>
	<div class="rtext"><button type="submit" id="add_button" class="btn btn-primary btn-block btn-lg" <?php echo $val; ?> > Add </button></div>
</form>
<br><br>
	<div class="ltext">
	<input type='hidden' name='id' id='move' class="form-control">
	</div>
	<div class="rtext"><a href="move_family.php" id="move_button" class="btn btn-primary btn-block btn-lg" <?php echo $val; ?> > Move </a></div>
    <br><br>
<form name="edit" action='edit_form.php' method='GET'>
	<div class="ltext">
	<input type='hidden' name='id' id='edit' class="form-control">
	</div>
	<div class="rtext"><button type="submit" id="edit_button" class="btn btn-primary btn-block btn-lg" disabled="disabled" <?php echo $val; ?> > edit </button>
    </div>
</form>
<br><br>
<form name="delete" action='delete.php' method='GET'>
	...
	<div class="rtext"><button type="submit" id="delete_button" class="btn btn-primary btn-block btn-lg" disabled="disabled" <?php echo $val; ?> >delete</button></div>
</form>
</div>
<?php
//============================================ family ============================================================
...
<?php echo $all;?>
  ...
  // do stuff 
   ...
   //var level1=data.id.parents.length;
   if(level==-1){
	   alert("kuy")
	   }
   //alert(level1)
